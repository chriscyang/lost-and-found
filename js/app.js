  ...
  const create = () => {
    ...
    pvt.groups = [
      Object.freeze({
        ...
        area: pvt.areas.ubc,
        members: [pvt.user, "Brian", "Eric", "Lisa", "Jodie"]
      }),
      Object.freeze({
        id: _.parseInt(_.uniqueId()),
    ...
    pvt.initTemplate = () => {
      pvt.Template = Object.freeze({
        ...
        INFO_WINDOW_NAME: _.template(
          $("#info-window-name-template")
            .html()
            .trim()
        ),
        INFO_WINDOW_ACTIONS: _.template(
          $("#info-window-actions-template")
            .html()
            .trim()
        )
      });
    ...
    pvt.bindProfile = () => {
      ...
      pvt.$sensitive.on("click", pvt.Selector.SUBMIT, function() {
        ...
        if (!_.isEmpty(location)) {
          pvt.$locations.append(
            pvt.Template.LOCATION({
              location: location
            })
          );
        } else {
